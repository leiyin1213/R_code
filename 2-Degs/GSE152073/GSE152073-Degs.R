...
#设置工作目录
setwd("D:/r/实验数据/2-Degs/GSE152073")

#读取输入文件
data=read.table("GSE152073.txt", header=T, sep="\t", check.names=F,row.names = 1)
#转化为matrix
...
abline(v=c(-lfc_cut, lfc_cut), lty=2, col="grey70")
abline(h=-log10(p_cut), lty=2, col="grey70")
